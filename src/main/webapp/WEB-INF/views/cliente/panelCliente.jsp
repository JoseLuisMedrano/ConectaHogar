...
<head>
    ...
    <link href="${pageContext.request.contextPath}/static/css/panelCliente.css" rel="stylesheet">
</head>
<body>

    <div id="panel-cliente-page">
        <nav class="sidebar">
            <h1 class="navbar-brand">
                <i class="bi bi-house-door-fill"></i> Panel Cliente
            </h1>
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="#" data-section="inicio">
                ...
                <div class="card card-body">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            <thead>
                                <tr>
                                    <th>ID</th><th>Servicio</th><th>Descripción</th><th>Fecha</th><th>Estado</th>
                                </tr>
                            </thead>
                            <tbody>
                                        ...
                                        <td>
                                            <span class="badge rounded-pill 
                                                <c:choose>
                                                    ...
                                                    <c:when test="${solicitud.estado == 'ACEPTADA'}">bg-success</c:when>
                                ...
                                <c:if test="${empty listaSolicitudes}">
                                    <tr><td colspan="5" class="text-center text-muted">Aún no has creado ninguna solicitud.</td></tr>
                                </c:if>
                            </tbody>
                        </table>
                    </div>
